...
type Interface interface {
	...
	CreateBoardingOwner(ctx context.Context, data *dtm.CreateBoardingOwner, roles []string) (bdOwnerKey string, err error)
	...
	ListAdsWithFilters(ctx context.Context, data *dtm.ListFilterQueryParams) (ads []*dtm.AdForList, adsCount, totalFilteredAds int, err error)
