...
type Interface interface {
	...
	ListMyEvents(ctx context.Context, userKey string, offset, count int) ([]*map[string]interface{}, error)
	DeleteEvent(ctx context.Context, userKey, eventKey string) error
}
